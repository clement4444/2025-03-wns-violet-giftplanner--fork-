...
export default function Wishlist() {
    ...
    const PLACEHOLDER = "https://images.unsplash.com/photo-1513201099705-a9746e1e201f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lmdHxlbnwwfHwwfHx8MA%3D%3D";
    ...
    return (
        <div className="min-h-screen py-2 px-2 mx-auto bg-[#EA4B09]">
            <div className="flex justify-between text-[#FDFBF6] p-3">
                ...
                <button className="flex items-center gap-2 bg-[#019645] text-[#FDFBF6] font-semibold px-4 py-2 rounded-xl hover:bg-[#01803b] transition">
            ...
            <div className="px-4">
                <ul className="grid pb-5 gap-4 grid-cols-[repeat(auto-fill,minmax(220px,1fr))]">
                    ...
                    <li key={i.id} className="border rounded p-3">
                        <img src={i.imageUrl ?? PLACEHOLDER} alt={i.name} className="w-full h-40 object-cover rounded mb-2"/>
